...
const TokenCard = ( { name, symbol, address, images } ) => (
    ...
    <div className="white-glassmorphism p-8 m-2 cursor-pointer hover:shadow-xl">
...
export default function Token() {
  return (
      <div className="flex w-full py-14 px-8 flex-col">
          <h1 className="p-4 text-center text-white text-3xl sm:text-5xl py-2 text-gradient">Tokens</h1>
          <div className="grid grid-cols-1 md:p-20 py-12 px-4 sm:grid-cols-3">
